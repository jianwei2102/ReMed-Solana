...
const MedicalRecord = () => {
    ...
    const onFinish = async (values: any) => {
        ...
        const recordHash = generateHash(record, wallet.publicKey.toBase58(), "HB56SU6Rb55MKKGsg962tqsRnZmriMM2Sej3FeFCzQxb");
                            ...
                            >
                                <Select
                                    ...
                                    options={[
                                        ...
                                        { value: "Ringing in Ears", label: "Ringing in Ears (Tinnitus)" },
                                        { value: "Mouth Sores", label: "Mouth Sores" },
                                        { value: "Fainting", label: "Fainting" },
                                        { value: "Swelling", label: "Swelling" },
                                        { value: "Numbness", label: "Numbness" },
                                        { value: "Tingling Sensation", label: "Tingling Sensation" },
